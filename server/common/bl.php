...
//    public function uquerybuilder($params,$indecator,$table){
       
    

//     return ["UPDATE $table  SET name = :name, director = :drct  WHERE $ind__c=$indecator" ,["name" =>$name,"drct" => $director,"id"=>$id,'table'=>$table]]

//    }
//    public function Dquerybuilder($indecator,$table)
